...
public class FriendPersonalAdapter extends RecyclerView.Adapter<FriendPersonalAdapter.FriendViewHolder> {

    private List<Student> friendList;
    private Context context;

    // Constructor
    public FriendPersonalAdapter(List<Student> friendList, Context context) {
    ...
    public static class FriendViewHolder extends RecyclerView.ViewHolder {
        ...
        public FriendViewHolder(@NonNull View itemView) {
            super(itemView);
            friendAvatar = itemView.findViewById(R.id.avatar_friend);
            friendName = itemView.findViewById(R.id.name_friend);
            button = itemView.findViewById(R.id.button_add_friends);
        }
    }
}
